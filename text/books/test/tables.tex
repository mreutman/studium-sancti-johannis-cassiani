...
\begin{center}
{\formatTextPsalmChapter DISTRIBÚZIO}
\end{center}

\begin{center}
\textbf{Secùndum Graecum}
\end{center}

{
  ...
  \begin{tabular}{|cccc|}
  \hline
  \multicolumn{1}{|c|}{\multirow{2}{*}{\textbf{Màįor}}} & \multicolumn{3}{c|}{\textbf{Mìnor}}   \\ \cline{2-4}
...
\begin{center}
\textbf{Triġìnta Diébus}
\end{center}

{
  \newcommand{\cA}{\textbf{Dies}}
  \newcommand{\cB}{\textbf{ad Mane}}
  \newcommand{\cC}{\textbf{ad Nocte}}
