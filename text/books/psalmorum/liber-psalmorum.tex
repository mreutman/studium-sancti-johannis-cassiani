...
\newcommand{\psalmDivision}[2]{%
  ...
  \begin{nscenter}
  \parbox{\textwidth}{%
    \raisebox{0.9ex}{\rule{2em}{1pt}}~~~{\scriptsize \raisebox{0.9ex}{\symbolCross}}~~{\bfseries\large\addfontfeature{LetterSpace=5.0}\fontdimen2\font=0.5em \textsc{Divizio} \RomanNumeralCaps{#1},~\RomanNumeralCaps{#2}.}~~{\scriptsize \raisebox{0.9ex}{\symbolCross}}~~~\raisebox{0.9ex}{\rule{20em}{1pt}}
  }
  \end{nscenter}
}
