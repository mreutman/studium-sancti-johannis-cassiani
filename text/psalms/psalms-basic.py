...
CHAPTER_VSPACE[127] = "\\psalmEndDecorate{0.5}"
...
CHAPTER_VSPACE[139] = "\\psalmEndNewPage"
CHAPTER_VSPACE[140] = "\\psalmEndDecorate{0.5}"
CHAPTER_VSPACE[141] = "\\psalmEnd{1}"
CHAPTER_VSPACE[142] = "\\psalmEndDecorateNewPage{1.0}"
