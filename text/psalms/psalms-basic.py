...
CHAPTER_VSPACE[32] = "\\psalmEndDecorateNewPage{2.0}"
...
CHAPTER_VSPACE[40] = "\\psalmEndDecorateNewPage{1.5}"
...
CHAPTER_VSPACE[54] = "\\psalmEndDecorateNewPage{1.0}"
...
CHAPTER_VSPACE[69] = "\\psalmEndDecorateNewPage{1.0}"
CHAPTER_VSPACE[70] = "\\psalmEndDecorate{2.0}"
...
CHAPTER_VSPACE[75] = "\\psalmEndDecorateNewPage{0.5}"
CHAPTER_VSPACE[76] = "\\psalmEnd{1}" #START HERE
