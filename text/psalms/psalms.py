...
class Psalms:
  ...
  def __init__(self):
    ...
    self.__dict2_vspace[2] = end_page()
    self.__dict2_vspace[3] = end_inter(1.5)
    self.__dict2_vspace[4] = end_page()
    self.__dict2_vspace[5] = end_inter(1.0)
    #self.__dict2_vspace[6] = end_page()
    self.__dict2_vspace[7] = end_inter(2.0)
    self.__dict2_vspace[8] = end_page_fill()
    self.__dict2_vspace[9] = end_inter(1.5)
    ...
    self.__dict2_vspace[16] = end_inter(1.5)
    self.__dict2_vspace[17] = end_page_fill()
    #self.__dict2_vspace[18] = end_inter(1.0)
    self.__dict2_vspace[19] = end_inter(2.0)
    ...
    self.__dict2_vspace[24] = end_page_fill()
    self.__dict2_vspace[25] = end_inter(1.5)
    #self.__dict2_vspace[26] = end_page()
    self.__dict2_vspace[27] = end_inter(1.5)
    self.__dict2_vspace[28] = end_page_fill()
    self.__dict2_vspace[29] = end_inter(1.5)
    self.__dict2_vspace[30] = end_inter(2.5)
    ...
    self.__dict2_vspace[35] = end_inter(1.5)
    #self.__dict2_vspace[36] = end_page_fill()
    self.__dict2_vspace[37] = end_inter(2.0)
    #self.__dict2_vspace[38] = end_inter(1.0)
    #self.__dict2_vspace[39] =
    self.__dict2_vspace[40] = end_inter(2.5)
    self.__dict2_vspace[41] = end_inter(2.0)
    self.__dict2_vspace[42] = end_page_fill() 
    ...
    #self.__dict2_vspace[47] = end_inter(1.0)
    #self.__dict2_vspace[48] = end_inter(1.0)
    self.__dict2_vspace[49] = end_inter(1.5)
    #self.__dict2_vspace[50] = end_inter(2.0)
    self.__dict2_vspace[51] = end_page()
    #self.__dict2_vspace[52] = end_inter(1.5)
    self.__dict2_vspace[53] = end_page_fill()
    #self.__dict2_vspace[54] =
    self.__dict2_vspace[55] = end_page()
    ...
    self.__dict2_vspace[61] = end_inter(1.0)
    self.__dict2_vspace[62] = end_page_fill()
    #self.__dict2_vspace[63] =
    #self.__dict2_vspace[64] = end_inter(2.0)
    self.__dict2_vspace[65] = end_inter(2.0)
    self.__dict2_vspace[66] = end_page_fill()
    self.__dict2_vspace[67] = end_page_fill()
    #self.__dict2_vspace[68] = end_page()
    #self.__dict2_vspace[69] =
    self.__dict2_vspace[70] = end_inter(1.5)
    ...
    self.__dict2_vspace[75] = end_inter(2.5)
    #self.__dict2_vspace[76] = end_inter(1.5)
    #self.__dict2_vspace[77] =
    self.__dict2_vspace[78] = end_inter(1.0)
    #self.__dict2_vspace[79] =
    self.__dict2_vspace[80] = end_inter(2.0)
    self.__dict2_vspace[81] = end_page_fill()
    #self.__dict2_vspace[82] = end_page_fill()
    self.__dict2_vspace[83] = end_inter(1.0)
    self.__dict2_vspace[84] = end_inter(2.0)
    #self.__dict2_vspace[85] = end_inter(1.5)
    #self.__dict2_vspace[86] =
    #self.__dict2_vspace[87] = end_inter(1.0)
    self.__dict2_vspace[88] = end_inter(2.0)
    self.__dict2_vspace[89] = end_inter(2.0)
    #self.__dict2_vspace[90] = end_page_fill()
    self.__dict2_vspace[91] = end_page_fill()
    #self.__dict2_vspace[92] = end_page()
    self.__dict2_vspace[93] = end_inter(1.5)
    #self.__dict2_vspace[94] = end_page()
    self.__dict2_vspace[95] = end_page()
    self.__dict2_vspace[96] = end_inter(1.5)
    #self.__dict2_vspace[97] = end_inter(1.5)
    #self.__dict2_vspace[98] = end_page()
    self.__dict2_vspace[99] = end_inter(1.5)
    #self.__dict2_vspace[100] = end_page()
    #self.__dict2_vspace[101] = end_inter(2.0)
    self.__dict2_vspace[102] = end_inter(1.5)
    self.__dict2_vspace[103] = end_page_fill()
    #self.__dict2_vspace[104] = end_page()
    self.__dict2_vspace[105] = end_page()
    self.__dict2_vspace[106] = end_page_fill()
    self.__dict2_vspace[107] = end_inter(2.0)
    #self.__dict2_vspace[108] = end_inter(1.5)
    #self.__dict2_vspace[109] = end_page_fill()
    self.__dict2_vspace[110] = end_inter(1.5)
    self.__dict2_vspace[111] = end_page_fill()
    #self.__dict2_vspace[112] =
    #self.__dict2_vspace[113] = end_inter(1.5)
    self.__dict2_vspace[114] = end_page_fill()
    self.__dict2_vspace[115] = end_inter(1.5)
    self.__dict2_vspace[116] = end_inter(1.5)
    self.__dict2_vspace[117] = end_page_fill()
    #self.__dict2_vspace[118] = end_inter(1.5)
    #self.__dict2_vspace[119] = end_page_fill()
    #self.__dict2_vspace[120] =
    self.__dict2_vspace[121] = end_page()
    self.__dict2_vspace[122] = end_inter(1.5)
    #self.__dict2_vspace[123] = end_inter(1.5)
    #self.__dict2_vspace[124] = end_page_fill()
    self.__dict2_vspace[125] = end_inter(1.5)
    self.__dict2_vspace[126] = end_page_fill()
    #self.__dict2_vspace[127] = end_inter(1.5)
    #self.__dict2_vspace[128] =
    self.__dict2_vspace[129] = end_inter(1.0)
    self.__dict2_vspace[130] = end_inter(1.0)
    self.__dict2_vspace[131] = end_inter(1.5)
    self.__dict2_vspace[132] = end_inter(1.5)
    self.__dict2_vspace[133] = end_page()
    self.__dict2_vspace[134] = end_page_fill()
    self.__dict2_vspace[135] = end_inter(2.5)
    self.__dict2_vspace[136] = end_page_fill()
    ...
    self.__dict2_vspace[143] = end_inter(2.0)
    #self.__dict2_vspace[144] =
    self.__dict2_vspace[145] = end_inter(1.5)
    self.__dict2_vspace[146] = end_page_fill()
    self.__dict2_vspace[147] = end_inter(2.0)
    #self.__dict2_vspace[148] = end_inter(1.0)
    #self.__dict2_vspace[149] = end_page()
    self.__dict2_vspace[150] = end_page()
