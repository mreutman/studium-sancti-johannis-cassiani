...
class Psalms:
  ...
  def __init__(self):
    ...
    self.__dict2_vspace[7] = end_inter(2.5)
    self.__dict2_vspace[8] = end_page()
    ...
    self.__dict2_vspace[27] = end_inter(2.0)
    ...
    self.__dict2_vspace[80] = end_inter(1.5)
    ...
    self.__dict2_vspace[102] = end_inter(2.0)
